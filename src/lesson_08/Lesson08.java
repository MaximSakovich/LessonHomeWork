...
public class Lesson08 {
    public static void main(String[] args) {
        ...
        if (x == 5) {
            ...
            System.out.println("if: x равен 9");
        } else {
            System.out.println("Что то другое if");
        }
        switch (x) {
            case 5:
            ...
            case 9:
                ...
                break;
            default:
                System.out.println("Что-то другое switch");
        }
        ...
        switch (xx) {
            case 5:
                System.out.println("switch: xx равен 5");
                break;
            case 7:
                System.out.println("switch: xx равен 7");
                break;
            case 9:
                System.out.println("switch: xx равен 9");
            default:
